...
Private Sub CmdAceptar_Click()
  If rstTem.State <> adStateClosed Then If rstTem.EOF = False Then FufuLo = rstTem.Fields("IdProducto") & ""
  Unload Me
End Sub
...
Sub Filtrar()
  ...
  Consulta = "SELECT IdProducto, NmProducto FROM Productos"
  If TxtBuscamos <> "" And CboCriterio.Text <> "" Then
    If CboCriterio.Text = "Codigo" Then Consulta = Consulta + " where IdProducto like '" & TxtBuscamos.Text & "%' order by NmProducto"
    If CboCriterio.Text = "Nombre" Then Consulta = Consulta + " where NmProducto like '" & TxtBuscamos.Text & "%' order by NmProducto"
  End If
