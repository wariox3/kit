...
Private Sub Timer1_Timer()
  If FufuSt <> "" Then
    If CpExisteFichero(GetSetting("Kit Logistics", "Configuracion", "DirImagenes") & "vehiculos\" & FufuSt & ".jpg") = True Then
      PicOrigen = LoadPicture(GetSetting("Kit Logistics", "Configuracion", "DirImagenes") & "vehiculos\" & FufuSt & ".jpg")
