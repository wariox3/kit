...
Begin VB.Form FrmConsultaRutas 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Consulta rutas..."
   ClientHeight    =   4665
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   6870
   ...
   Begin VB.ComboBox CboCriterio 
      Height          =   315
      ItemData        =   "FrmConsultaRutas.frx":0000
      Left            =   120
      List            =   "FrmConsultaRutas.frx":000A
   ...
   End
End
Attribute VB_Name = "FrmConsultaRutas"
...
Private Sub CmdAceptar_Click()
  If rstTem.State <> adStateClosed Then If rstTem.EOF = False Then Ello = rstTem.Fields("IdRuta") & ""
  Unload Me
End Sub
...
Sub Filtrar()
  ...
  Consulta = "SELECT IdRuta, NmRuta FROM Rutas "
  If TxtBuscamos <> "" And CboCriterio.Text <> "" Then
    If CboCriterio.Text = "Codigo" Then Consulta = Consulta + " where IdRuta like '" & TxtBuscamos.Text & "%' order by NmRuta"
    If CboCriterio.Text = "Nombre" Then Consulta = Consulta + " where NmRuta like '" & TxtBuscamos.Text & "%' order by NmRuta"
  End If
