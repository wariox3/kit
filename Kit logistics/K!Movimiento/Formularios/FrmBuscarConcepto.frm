...
Begin VB.Form FrmBuscarConcepto 
   ...
   Begin VB.ComboBox CboCriterio 
      Height          =   315
      ItemData        =   "FrmBuscarConcepto.frx":0000
      Left            =   120
      List            =   "FrmBuscarConcepto.frx":000A
   ...
   End
End
Attribute VB_Name = "FrmBuscarConcepto"
...
Private Sub CmdAceptar_Click()
  If rstTem.State <> adStateClosed Then If rstTem.EOF = False Then FufuLo = rstTem.Fields("IdConcepto") & ""
  Unload Me
End Sub
...
Sub Filtrar()
  ...
  Consulta = "SELECT IdConcepto, NmConcepto, Tipo FROM conceptoscontables "
  If TxtBuscamos <> "" And CboCriterio.Text <> "" Then
    If CboCriterio.Text = "Codigo" Then Consulta = Consulta + " where IdConcepto like '%" & TxtBuscamos.Text & "%' order by NmConcepto"
    If CboCriterio.Text = "Nombre" Then Consulta = Consulta + " where NmConcepto like '%" & TxtBuscamos.Text & "%' order by NmConcepto"
  End If
