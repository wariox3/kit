...
Begin VB.Form FrmConfiguracionGeneral 
   ...
   Begin TabDlg.SSTab SSTabConfiguracion 
      ...
      Tab(1).Control(6)=   "CmdCargar"
      Tab(1).Control(7)=   "TxtRutaReportes"
      Tab(1).Control(8)=   "CmdCargarRutaReportes"
      Tab(1).Control(9)=   "CmdCargarRutaImagenes"
      Tab(1).Control(10)=   "TxtRutaImagenes"
      ...
      Tab(2).Control(11)=   "TxtEmail"
      Tab(2).Control(12)=   "TxtDireccionTerritorial"
      Tab(2).Control(13)=   "TxtAseguradora"
      Tab(2).Control(14)=   "TxtNitAseguradora"
      Tab(2).Control(15)=   "TxtVencePoliza"
      Tab(2).Control(16)=   "TxtNroPoliza"
      Tab(2).Control(17)=   "TxtDireccionEmpresa"
      Tab(2).Control(18)=   "TxtTelefonoEmpresa"
      Tab(2).Control(19)=   "TxtNombreEmpresa"
      Tab(2).Control(20)=   "TxtNitEmpresa"
      Tab(2).Control(21)=   "TxtResMinisterio"
