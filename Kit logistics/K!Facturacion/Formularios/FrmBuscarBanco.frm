...
Begin VB.Form FrmBuscarBanco 
   ...
   Begin VB.ComboBox CboCriterio 
      Height          =   315
      ItemData        =   "FrmBuscarBanco.frx":0000
      Left            =   120
      List            =   "FrmBuscarBanco.frx":000A
   ...
   End
End
Attribute VB_Name = "FrmBuscarBanco"
...
Private Sub CmdAceptar_Click()
  If rstTem.State <> adStateClosed Then If rstTem.EOF = False Then FufuLo = rstTem.Fields("codigo_banco_pk") & ""
  Unload Me
End Sub
...
Sub Filtrar()
  ...
  Consulta = "SELECT codigo_banco_pk, nombre FROM bancos "
  If TxtBuscamos <> "" And CboCriterio.Text <> "" Then
    If CboCriterio.Text = "Codigo" Then Consulta = Consulta + " where codigo_banco_pk like '" & TxtBuscamos.Text & "%' order by NmAsesor"
